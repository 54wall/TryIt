...
import com.example.android.systemupdatersample.util.PackageUtil;
...
public class MainActivity extends Activity {
	...
	this.mTextViewAppVersion = findViewById(R.id.textViewAppVersion);
    ...
    public void onLocalUpdateClick(View view) {
        new AlertDialog.Builder(this)
                .setTitle("Apply Local Update")
                .setMessage("Do you really want to apply this update?")
                .setIcon(android.R.drawable.ic_dialog_alert)
                .setPositiveButton(android.R.string.ok, (dialog, whichButton) -> {
                    try {
                        uiResetWidgets();
                        uiResetEngineText();
                        applyUpdate(UpdateConfig.fromJson(readResource(R.raw.sample_sd)));
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                })
    ...
    private void uiResetWidgets() {
        ...
        mTextViewAppVersion.setText("app version:"+PackageUtil.getPackageVersionName(this, this.getPackageName()));
