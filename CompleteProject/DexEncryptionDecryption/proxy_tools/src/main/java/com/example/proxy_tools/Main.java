...
public class Main {
    ...
    public static void makeDecodeDex() throws IOException, InterruptedException {
        ...
        //dx --dex --output D:\Develop\Demo\Android\Study\yangkun19921001\DexEncryptionDecryption\proxy_tools\temp\classes.dex D:\Develop\Demo\Android\Study\yangkun19921001\DexEncryptionDecryption\proxy_tools\temp\classes.jar
        /**
         * D:\Develop\Android\Sdk\build-tools\30.0.3\dx.bat --dex --output D:\Develop\Demo\Android\Study\yangkun19921001\DexEncryptionDecryption\proxy_tools\temp\classes.dex D:\Develop\Demo\Android\Study\yangkun19921001\DexEncryptionDecryption\proxy_tools\temp\classes.jar
         */
//       Windows 执行
        Process process = Runtime.getRuntime().exec("cmd /c D:\\Develop\\Android\\Sdk\\build-tools\\30.0.3\\dx.bat --dex --output " + classesDex.getAbsolutePath()
...
//        AES.init(AES.DEFAULT_PWD);
    ...
    private static void zipalign() throws IOException, InterruptedException {
        ...
        String s = "cmd /c D:\\Develop\\Android\\Sdk\\build-tools\\30.0.3\\zipalign.exe -v -p  4 " + unSignedApk.getAbsolutePath()
                + " " + alignedApk.getAbsolutePath();
        System.out.println("zipalign() s:"+s);
        //Windows 执行
...
//        if (process.exitValue() != 0) {
//            throw new RuntimeException("zipalign失败");
//        }
    ...
    public static void jksToApk() throws IOException, InterruptedException {
        ...
        //apksigner sign --ks my-release-key.jks --out my-app-release.apk my-app-unsigned-aligned.apk
        /**
         * C:\Users\tdr>D:\Develop\Android\Sdk\build-tools\30.0.3\apksigner.bat sign --ks D:\Develop\Demo\Android\Study\yangkun19921001\DexEncryptionDecryption\proxy_tools\dexjks.jks --ks-key-alias yangkun --ks-pass pass:123123 --key-pass pass:123123 --out D:\Develop\Demo\Android\Study\yangkun19921001\DexEncryptionDecryption\app\release\app-signed-aligned.apk D:\Develop\Demo\Android\Study\yangkun19921001\DexEncryptionDecryption\app\build\outputs\apk\debug\app-unsigned-aligned.apk
         *
         * ERROR: JAVA_HOME is set to an invalid directory: D:\Develop\JDK\1.8\bin
         *
         * Please set the JAVA_HOME variable in your environment to match the
         * location of your Java installation.
         */
        //Windows 执行
        String s = "cmd /c D:\\Develop\\Android\\Sdk\\build-tools\\30.0.3\\apksigner.bat sign --ks " + jks.getAbsolutePath()
                + " --ks-key-alias yangkun --ks-pass pass:123123 --key-pass pass:123123 --out "
                + signedApk.getAbsolutePath() + " " + alignedApk.getAbsolutePath();
        System.out.println("jksToApk s:"+s);
        //直接在windows下cmd命令行中执行可以得到打包文件，否则还是报
        Process process = Runtime.getRuntime().exec(s);
