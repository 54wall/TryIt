...
public class WordUtils {
    ...
    private String lineBegin = " ", lineEnd = " ";
    ...
    public String word2html() {
        try {
            output = new FileOutputStream(new File(htmlPath), true);
            presentPicture = 0;
//            output.write(htmlBegin.getBytes());
            output.write((docPath.substring(docPath.lastIndexOf("/") + 1)).getBytes());
            output.write(("\n").getBytes());
