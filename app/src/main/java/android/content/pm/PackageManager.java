...
public abstract class PackageManager {
     ...
     *
     * @param packageName The full name (i.e. com.google.apps.contacts) of the desired
     *                    package.
     ...
     *
     * @param name  The fully qualified name (i.e. com.google.permission.LOGIN) of
     ...
     *
     * @param group The fully qualified name (i.e. com.google.permission.LOGIN) of
     ...
     * </p>
     *
     * @param intent An intent containing all of the desired specification (action,
     ...
     *
     * @param processName If non-null, limits the returned providers to only those that
     ...
     *
     * @param className The full name (i.e. com.google.apps.contacts.InstrumentList)
     ...
     *
     * @param packageName The name of the package that this icon is coming from. Can not
     *                    be null.
     * @param resid       The resource identifier of the desired image. Can not be 0.
     * @param appInfo     Overall information about <var>packageName</var>. This may be
     ...
     * @throws NameNotFoundException Thrown if the resources for the given activity could not be
     *                               loaded.
     ...
     * @return Returns the image of the icon, or the default activity icon if it
     * could not be found. Does not return null.
     * @throws NameNotFoundException Thrown if the resources for application matching the given
     ...
     *
     * @param packageName Name of the package whose application icon is to be retrieved.
     * @return Returns the image of the icon, or the default application icon if
     * it could not be found. Does not return null.
     * @throws NameNotFoundException Thrown if the resources for the given application could not
     *                               be loaded.
     ...
     * found, NameNotFoundException is thrown.
     *
     * @param packageName Name of the package whose application logo is to be retrieved.
     ...
     *
     * @param packageName The name of the package that this text is coming from. Can not
     *                    be null.
     ...
     *
     * @param packageName The name of the package that this xml is coming from. Can not
     *                    be null.
     ...
     *
     * @param activityName Name of the activity whose resources are to be retrieved.
     ...
     *
     * @param appPackageName Package name of the application whose resources are to be
     *                       retrieved.
     * @return Returns the application's Resources.
     * @throws NameNotFoundException Thrown if the resources for the given application could not
     *                               be loaded.
     ...
     *                             the installation. This identifies which market the package
     *                             came from.
     * @param verificationURI      The location of the supplementary verification file. This can
     ...
     * @param verificationCode either {@link PackageManager#VERIFICATION_ALLOW} or
     *                         {@link PackageManager#VERIFICATION_REJECT}.
     */
     ...
     * @param installerPackageName The package name of the new installer. May be null to clear
     *                             the association.
     */
     ...
     * @param observer    An observer callback to get notified when the operation is
     *                    finished
     ...
     *
     * @param packageName The name of the package to delete
     * @param observer    An observer callback to get notified when the cache file
     ...
     *
     * @param freeStorageSize The number of bytes of storage to be freed by the system. Say
     *                        if freeStorageSize is XX, and the current free storage is YY,
     *                        if XX is less than YY, just return. if not free XX-YY number
     *                        of bytes if possible.
     * @param observer        call back used to notify when the operation is completed
     * @hide
     */
     ...
     *                        if XX is less than YY, just return. if not free XX-YY number
     *                        of bytes if possible.
     * @param pi              IntentSender call back used to notify when the operation is
    ...
    /**
     * @param filter   The set of intents under which this activity will be made
     *                 preferred.
     * @param match    The IntentFilter match category that this preference applies
     *                 to.
     * @param set      The set of activities that the user was picking from when this
     *                 preference was made.
     ...
     * own package(s).
     *
     * @param packageName The name of the package whose preferred activity mappings are
     *                    to be removed.
     */
     ...
     * system.
     *
     * @param outFilters    A list in which to place the filters of all of the preferred
     *                      activities, or null for none.
     * @param outActivities A list in which to place the component names of all of the
     *                      preferred activities, or null for none.
     * @param packageName   An option package in which you would like to limit the list.
     ...
     */
    private static class NameNotFoundException extends AndroidException {
