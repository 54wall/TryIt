...
import pri.weiqiang.tryit.reader.widget.animation.PageAnimation;
import pri.weiqiang.tryit.reader.widget.animation.ScrollPageAnim;
...
//        }
        Log.e(TAG, "mPageLoader.drawPage(getNextBitmap(), false)");
    ...
    public void drawCurPage(boolean isUpdate) {
        ...
        Log.e(TAG, "mPageLoader.drawPage(getNextBitmap(), isUpdate)");
    ...
    public PageLoader getPageLoader(CollBookBean collBook) {
        Log.e(TAG, "获取目的图书位置 PageLoader " + collBook.getCover());
        // 判是否已经存在
        if (mPageLoader != null) {
            return mPageLoader;
        }
