package pri.weiqiang.tryit.reader.widget.animation;
...
/*          //擦除其Bitmap(重新创建会不会更好一点)
    ...
    private void fillUp(int topEdge, int offset) {
        Log.e(TAG, "fillUp() 创建View填充顶部空白部分");
        // 首先进行布局的调整
    ...
    private void eraseBitmap(Bitmap b, int width, int height,
        ...
        Log.e(TAG, "eraseBitmap() 对Bitmap进行擦除");
...
/*        //设置背景透明
    ...
    public Bitmap getBgBitmap() {
        Log.e(TAG, "getBgBitmap() ");
        return mBgBitmap;
    }

    @Override
    public Bitmap getNextBitmap() {
        Log.e(TAG, "getNextBitmap() ");
        return mNextBitmap;
    }
