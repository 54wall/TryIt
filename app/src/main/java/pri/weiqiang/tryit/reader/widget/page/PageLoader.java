...
import pri.weiqiang.tryit.reader.bean.BookRecordBean;
import pri.weiqiang.tryit.reader.bean.CollBookBean;
import pri.weiqiang.tryit.reader.local.ReadSettingManager;
...
import pri.weiqiang.tryit.reader.utils.ScreenUtils;
...
public abstract class PageLoader {
    ...
    public boolean skipPreChapter() {
        Log.e(TAG, "skipPreChapter 跳转到上一章");
        if (!hasPrevChapter()) {
            return false;
        }
    ...
    public boolean skipNextChapter() {
        Log.e(TAG, "skipNextChapter 跳转到下一章");
        if (!hasNextChapter()) {
            return false;
        }
    ...
    public boolean skipToNextPage() {
        Log.e(TAG, "翻到下一页 skipToNextPage");
    ...
    public void setPageMode(PageMode pageMode) {
        Log.e(TAG, "setPageMode 翻页模式 " + pageMode);
        mPageMode = pageMode;
...
//        }
    ...
    public void openChapter() {
        ...
        if (parseCurChapter()) {
            ...
            // 如果章节从未打开
            if (!isChapterOpen) {
                Log.e(TAG, "!isChapterOpen 如果章节从未打开");
    ...
    private void drawContent(Bitmap bitmap) {
        ...
        if (mStatus != STATUS_FINISH) {
            ...
            for (int i = mCurPage.titleLines; i < mCurPage.lines.size(); ++i) {
                Log.e(TAG, "对内容进行绘制mCurPage.lines.get(" + i + "):" + mCurPage.lines.get(i));
                str = mCurPage.lines.get(i);
