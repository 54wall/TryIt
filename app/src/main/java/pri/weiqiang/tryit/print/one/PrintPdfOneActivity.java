...
public class PrintPdfOneActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_print_pdf_one);
    ...
    private void onPrintPdf() {
        ...
        printManager.print("test pdf print", new MyPrintAdapter(this, path + pdfName), builder.build());
    }
        ...
        public void onLayout(PrintAttributes oldAttributes, PrintAttributes newAttributes, CancellationSignal cancellationSignal,
            ...
            if (Build.VERSION.SDK_INT >= 23) {
                ...
                for (String str : permissions) {
                    if (PrintPdfOneActivity.this.checkSelfPermission(str) != PackageManager.PERMISSION_GRANTED) {
                        //申请权限
                        PrintPdfOneActivity.this.requestPermissions(permissions, REQUEST_CODE_CONTACT);
                        return;
                    }
                }
            }
